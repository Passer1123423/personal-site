...
const ACTION_OPTIONS: SearchablePickerOption[] = [
  ...
  {
    value: "user.admin.create",
    label: "管理员创建用户",
    description: "user.admin.create",
    badge: "用户",
    searchText: "user.admin.create 管理员 用户 创建",
  },
  {
    value: "user.admin.update",
    label: "管理员更新用户",
    description: "user.admin.update",
    badge: "用户",
    searchText: "user.admin.update 管理员 用户 更新 修改",
  },
  {
    value: "user.admin.password_reset",
    label: "管理员重置密码",
    description: "user.admin.password_reset",
    badge: "用户",
    searchText: "user.admin.password_reset 管理员 用户 密码 重置",
  },
  {
    value: "user.admin.delete",
    label: "管理员删除用户",
    description: "user.admin.delete",
    badge: "用户",
    searchText: "user.admin.delete 管理员 用户 删除",
  },
  {
    value: "user.admin.delete.failed",
    label: "管理员删除用户失败",
    description: "user.admin.delete.failed",
    badge: "失败",
    searchText: "user.admin.delete.failed 管理员 用户 删除 失败",
  },
  {
  ...
  {
    value: "comic.series.summary_update",
    label: "修改漫画系列简介",
    description: "comic.series.summary_update",
    badge: "漫画",
    searchText: "comic.series.summary_update 漫画 系列 简介 修改",
  },
  {
    value: "comic.series.cover_upload",
    label: "上传漫画系列封面",
    description: "comic.series.cover_upload",
    badge: "漫画",
    searchText: "comic.series.cover_upload 漫画 系列 封面 上传",
  },
  {
    value: "comic.series.cover_upload.failed",
    label: "上传漫画系列封面失败",
    description: "comic.series.cover_upload.failed",
    badge: "失败",
    searchText: "comic.series.cover_upload.failed 漫画 系列 封面 上传 失败",
  },
  {
  ...
  {
    value: "comic.series.delete.failed",
    label: "删除漫画系列失败",
    description: "comic.series.delete.failed",
    badge: "失败",
    searchText: "comic.series.delete.failed 漫画 系列 删除 失败",
  },
  {
  ...
  {
    value: "comic.part.summary_update",
    label: "修改漫画 Part 简介",
    description: "comic.part.summary_update",
    badge: "漫画",
    searchText: "comic.part.summary_update 漫画 part 简介 修改",
  },
  {
    value: "comic.part.owner_update",
    label: "修改漫画 Part 作者",
    description: "comic.part.owner_update",
    badge: "漫画",
    searchText: "comic.part.owner_update 漫画 part 作者 修改",
  },
  {
    value: "comic.part.cover_upload",
    label: "上传漫画 Part 封面",
    description: "comic.part.cover_upload",
    badge: "漫画",
    searchText: "comic.part.cover_upload 漫画 part 封面 上传",
  },
  {
    value: "comic.part.cover_upload.failed",
    label: "上传漫画 Part 封面失败",
    description: "comic.part.cover_upload.failed",
    badge: "失败",
    searchText: "comic.part.cover_upload.failed 漫画 part 封面 上传 失败",
  },
  {
  ...
  {
    value: "comic.part.delete.failed",
    label: "删除漫画 Part 失败",
    description: "comic.part.delete.failed",
    badge: "失败",
    searchText: "comic.part.delete.failed 漫画 part 删除 失败",
  },
  {
  ...
  {
    value: "comic.chapter.delete.failed",
    label: "删除漫画章节失败",
    description: "comic.chapter.delete.failed",
    badge: "失败",
    searchText: "comic.chapter.delete.failed 漫画 章节 删除 失败",
  },
  {
  ...
  {
    value: "comic_upload.image.delete.failed",
    label: "删除待传区图片失败",
    description: "comic_upload.image.delete.failed",
    badge: "失败",
    searchText: "comic_upload.image.delete.failed 漫画 待传区 图片 删除 失败",
  },
  {
  ...
  {
    value: "comic_upload.image.clear.failed",
    label: "清空待传区失败",
    description: "comic_upload.image.clear.failed",
    badge: "失败",
    searchText: "comic_upload.image.clear.failed 漫画 待传区 清空 失败",
  },
  {
  ...
  {
    value: "comic_upload.chapter.publish.failed",
    label: "发布待传区章节失败",
    description: "comic_upload.chapter.publish.failed",
    badge: "失败",
    searchText: "comic_upload.chapter.publish.failed 漫画 待传区 发布 章节 失败",
  },
  {
    value: "novel.create",
    label: "创建小说",
  ...
  {
    value: "novel.summary_update",
    label: "修改小说简介",
    description: "novel.summary_update",
    badge: "小说",
    searchText: "novel.summary_update 小说 简介 修改",
  },
  {
    value: "novel.owner_update",
    label: "修改小说作者",
    description: "novel.owner_update",
    badge: "小说",
    searchText: "novel.owner_update 小说 作者 修改",
  },
  {
    value: "novel.cover_upload",
    label: "上传小说封面",
    description: "novel.cover_upload",
    badge: "小说",
    searchText: "novel.cover_upload 小说 封面 上传",
  },
  {
    value: "novel.cover_upload.failed",
    label: "上传小说封面失败",
    description: "novel.cover_upload.failed",
    badge: "失败",
    searchText: "novel.cover_upload.failed 小说 封面 上传 失败",
  },
  {
    value: "novel.delete",
    label: "删除小说",
  ...
  {
    value: "novel.delete.failed",
    label: "删除小说失败",
    description: "novel.delete.failed",
    badge: "失败",
    searchText: "novel.delete.failed 小说 删除 失败",
  },
  {
  ...
  {
    value: "novel.chapter.image_upload",
    label: "上传小说章节图片",
    description: "novel.chapter.image_upload",
    badge: "小说",
    searchText: "novel.chapter.image_upload 小说 章节 图片 上传",
  },
  {
    value: "novel.chapter.image_delete",
    label: "删除小说章节图片",
    description: "novel.chapter.image_delete",
    badge: "小说",
    searchText: "novel.chapter.image_delete 小说 章节 图片 删除",
  },
  {
  ...
  {
    value: "novel.chapter.delete.failed",
    label: "删除小说章节失败",
    description: "novel.chapter.delete.failed",
    badge: "失败",
    searchText: "novel.chapter.delete.failed 小说 章节 删除 失败",
  },
  {
  ...
  {
    value: "novel.buffer.publish_new_chapter",
    label: "从缓冲区发布新章节",
    description: "novel.buffer.publish_new_chapter",
    badge: "缓冲",
    searchText: "novel.buffer.publish_new_chapter 小说 buffer 缓冲区 发布 新章节",
  },
  {
